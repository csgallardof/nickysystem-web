...
function mnky_custom_css() {
	...
	// Accent color (color)
	$custom_css .= '
		dt,.wpb_button.wpb_btn_themecolor.wpb_btn-minimal, .themecolor_txt, #site-header #site-navigation ul li a:hover, #site-header #site-navigation .search_button:hover, #site-header #site-navigation .header_cart_button:hover, #site-header #site-navigation ul li.megamenu ul li a:hover, #site-header #site-navigation ul li.current-menu-item > a,.single-post #site-header #site-navigation ul li.current_page_parent > a, #site-header #site-navigation ul li.current-menu-ancestor > a, a:hover, #site-header #site-navigation ul li.megamenu ul li.current-menu-item > a,.single-post #site-header #site-navigation ul li.megamenu ul li.current_page_parent > a,#site-header #site-navigation ul li.megamenu ul li.current-menu-ancestor > a, .widget a, span.required, #comments .comment-reply-link:hover,#comments .comment-meta a:hover, .wpb_toggle:before, #content h4.wpb_toggle:before, .post-entry-header .entry-meta a:hover, .tag-links:before, #comments p.comment-notes:before, p.logged-in-as:before, p.must-log-in:before, .entry-meta-footer .meta-date:before, article.sticky .post-preview:after, .separator_w_icon i, blockquote:after, article.format-quote .quoute-text:after, article.format-link .link-text:after, article.format-status .status-text:after, article.format-chat p:nth-child(odd):before, .entry-meta-footer a:hover, .footer-sidebar a:hover, .team_member_position{color:'. ot_get_option('accent_color', '#8fc941') .';}		
	';
	...
	if (class_exists( 'WooCommerce' )){
		$custom_css .= '
			.woocommerce div.product span.price,.woocommerce div.product p.price,.woocommerce #content div.product span.price,.woocommerce #content div.product p.price,.woocommerce-page div.product span.price,.woocommerce-page div.product p.price,.woocommerce-page #content div.product span.price,.woocommerce-page #content div.product p.price, .woocommerce ul.products li.product .price,.woocommerce-page ul.products li.product .price, #site-header #site-navigation .header_cart_widget .woocommerce ul li:hover a, #site-navigation .header_cart_widget .woocommerce .buttons a:hover, .woocommerce ul li.product-category:hover h3,.woocommerce ul li.product-category:hover h3 mark {color:'. ot_get_option('accent_color', '#8fc941') .';}		
		';
	...
	( ! empty( $menu_font['font-family'] ) ) ? $menu_font_family = $menu_font['font-family'] : $menu_font_family = 'Ubuntu';
	...
	if ( ! empty( $menu_font ) ){
		$menu_font_styles = array(
			($menu_font['font-weight'] != '') ? 'font-weight:'. $menu_font['font-weight'] : null,
			($menu_font['font-style'] != '') ? 'font-style:'. $menu_font['font-style'] : null,
			($menu_font['letter-spacing'] != '') ? 'letter-spacing:'. $menu_font['letter-spacing'] : null,
			($menu_font['text-transform'] != '') ? 'text-transform:'. $menu_font['text-transform'] : null,
